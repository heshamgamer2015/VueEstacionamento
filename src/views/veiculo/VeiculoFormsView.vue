    ...
    <div class="container col-6">
        ...
        <div class="row">
            <div class="col-md-12 text-start">
                ...
                <input type="text"  class="form-control" placeholder="ABC-1234 || AAA1A12"
