    ...
    <div class="container col-6">
        ...
        <div class="row">
            ...
            <div class="col-md-12 text-start">
                ...
                <input type="text"  class="form-control" placeholder="121.121.121-12" v-model="condutor.cpf">
            </div>
            <div class="col-md-12 text-start">
                <label class="form-label mt-3" >Telefone do Condutor *</label>
                <input type="text" class="form-control" placeholder="+12(121)12121-1212" v-model="condutor.telefone">
            </div>
        </div>
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-3 ">
                <div class="d-grid gap-2">
                    ...
                    <button  type="button" class="btn btn-warning" @click="onClickEditar()">
                        Editar
                    </button>
                    <button  type="button" class="btn btn-danger" @click="onClickExcluir()">
                        Excluir
                    </button>
                </div>
            </div>
...
import  condutorClient  from '@/client/codutor.client';
