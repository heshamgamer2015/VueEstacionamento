        ...
        <div class="row mt-3">
            ...
            <div class="col-md-3 ">
                <div class="d-grid gap-2">
                    ...
                    <button type="button" class="btn btn-info" @click="FinalizarMovimentacao()">
                        Finalizar
                    </button>
                </div>
            </div>
...
import  condutorClient, {  CondutorClient }  from '@/client/codutor.client';
